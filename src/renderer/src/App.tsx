...
import AccountDetails from '@renderer/components/steppedForm/AccountDetails'
import { SelectFiles } from '@renderer/components/steppedForm/SelectFiles'
import SelectFolder from '@renderer/components/steppedForm/SelectFolder'
import PersonalInfo from '@renderer/components/steppedForm/PersonalInfo'
import Success from '@renderer/components/steppedForm/Success'
import Stepper, { Step } from '@renderer/components/steppedForm/Stepper'
import { Button } from '@renderer/components/ui/button'
import { useAppDispatch, useAppSelector } from '@renderer/app/hooks'
import { useHandShakeExpressQuery } from '@renderer/api/api'
import Geolocations from '@renderer/components/steppedForm/Geolocations'
